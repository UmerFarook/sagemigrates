...
function Page() {
    ...
    const tabData = [
        {
            ...
            title: "Why Canada?",
            paragraphs: [
                "Discover the key advantages of migrating to Canada:"
            ],
            list: [
                "The world’s leading immigration program.",
                "Move to Canada in under 6 months.",
                "Canada aims to attract 1.1 million immigrants by 2027.",
                "Access free education for your children.",
                "Bring your relatives to Canada by sponsoring them.",
                "Canada is set to welcome 1.5 million newcomers by 2027."
            ]
        },
        {
            id: "vision",
            ...
            paragraphs: [
                "Popular immigration programmes available in Canada include:"
            ],
            list: [
                "Express Entry",
                "PNP",
    ...
    return(
        <>
            <section id="call-action" className="call-action canada">
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-xxl-6 col-xl-7 col-lg-8 col-md-9">
                            <div className="inner-content">
                                <img src="/images/logo-gold-alone.png" className="margin-30 pt-90" width="200"/>
                                <h2>Canada</h2>
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 col-12">
                            <div className="about-image-five">
                                ...
                                <img src="/images/canada-2.jpg" alt="about"/>
                            </div>
                        </div>
                        <div className="col-lg-6 col-12">
                            <div className="about-five-content">
                                <h6 className="small-title text-lg">OUR SERVICES</h6>
                                <h2 className="main-title fw-bold">Explore the top benefits of moving to Canada</h2>
                                <Tabs tabs={tabData} ><p>Discover the key advantages of migrating to Canada:</p></Tabs>
                            </div>
                        </div>
                    </div>
                </div>
