...
export default function Home() {const tabData = [
    {
        "id": "who",
        "title": "About Us",
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-4 col-md-12 col-12">
                            <div className="header-content">
                                ...
                                <p>
                                    We are committed to delivering exceptional service to our clients, ensuring a
                                    seamless and positive experience throughout the entire process.
                                </p>
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="content">
                                    ...
                                    <p>
                                        Planning to study abroad? SAGE Consultancy offers end-to-end guidance from
                                        choosing the right program to settling in confidently overseas.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-services">
                                ...
                                <div className="service-content">
                                    ...
                                    <p>
                                        Discover the best study program for your skills and interests with expert
                                        guidance from SAGE Consultancy. We help you choose top universities and the
                                        ideal country for an exceptional educational experience.
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-services">
                                ...
                                <div className="service-content">
                                    ...
                                    <p>
                                        Applying can feel overwhelming, but with SAGE Consultancy, it doesn't have to
                                        be. Our experts help you craft strong essays, perfect your application, and
                                        submit everything accurately and on time. </p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6">
                            <div className="single-services">
                                ...
                                <div className="service-content">
                                    ...
                                    <p>Get ready for your international journey with SAGE Consultancy. We help with
                                        foreign exchange, airport pickup, insurance, and a packing list ensuring you're
                                        fully prepared for your adventure.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="row justify-content-center">
                        <div className="col-xxl-6 col-xl-7 col-lg-8 col-md-9">
                            <div className="inner-content">
                                ...
                                <p>
                                    With years of expertise in global education and immigration, we simplify complex
                                    visa processes and unlock life-changing opportunities.<br/> Whether you're aiming to
                                    study, work, or settle abroad, our team guides you every step of the way with
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="content">
                                    ...
                                    <p>
                                        Your global journey begins here to unlock career, study, and settlement
                                        opportunities in Europe, Canada, Australia, and New Zealand.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="row">
                        <div className="col-lg-3 col-md-6 col-12">
                            ...
                            <div className="single-news">
                                <div className="image">
                                    <a href="javascript:void(0)"><img className="thumb"
                                                                      src="/images/blog/australia.jpg"
                                                                      alt="Blog"/></a>
                                    <div className="meta-details">
                                        <img className="thumb" src="/images/blog/australia.jpg" alt="Author"/>
                                        <span><Link href="/Australia"><span>Read More</span></Link> </span>
                                    </div>
                                </div>
                                <div className="content-body">
                                    ...
                                    <p>
                                        Australia continues to attract professionals from around the world with its
                                        strong economy, diverse job market, and exceptional quality of life. It’s not
                                        just about employment it’s about building a future in a country known for
                                        opportunity, innovation, and balance.
                        ...
                        <div className="col-lg-3 col-md-6 col-12">
                            ...
                            <div className="single-news">
                                <div className="image">
                                    <a href="javascript:void(0)"><img className="thumb"
                                                                      src="/images/blog/europe-3.jpg"
                                                                      alt="Blog"/></a>
                                    <div className="meta-details">
                                        <img className="thumb" src="/images/blog/europe-3.jpg" alt="Author"/>
                                        <span><Link href="/Europe"><span>Read More</span></Link> </span>
                                    </div>
                                </div>
                                <div className="content-body">
                                    <h4 className="title">
                                    ...
                                    <p>
                                        ...
                                        Europe isn’t just a destination, it’s a launchpad for opportunity. With
                                        world-renowned universities, a culturally rich ecosystem, and progressive career
                                        landscapes, Europe offers more than a degree or a job; it offers transformation.
                        ...
                        <div className="col-lg-3 col-md-6 col-12">
                            ...
                            <div className="single-news">
                                <div className="image">
                                    <a href="javascript:void(0)"><img className="thumb"
                                                                      src="/images/blog/canada.jpg" alt="Blog"/></a>
                                    <div className="meta-details">
                                        <img className="thumb" src="/images/blog/canada.jpg" alt="Author"/>
                                        <Link href="/Canada"><span>Read More</span></Link>
                                    </div>
                                </div>
                                <div className="content-body">
                                    <h4 className="title">
                        ...
                        <div className="col-lg-3 col-md-6 col-12">
                            ...
                            <div className="single-news">
                                <div className="image">
                                    <a href="javascript:void(0)"><img className="thumb"
                                                                      src="/images/blog/new-zealand.jpg"
                                                                      alt="Blog"/></a>
                                    <div className="meta-details">
                                        <img className="thumb" src="/images/blog/new-zealand.jpg" alt="Author"/>
                                        <Link href="/NewZealand"><span>Read More</span></Link>
                                    </div>
                                </div>
                                <div className="content-body">
                                    <h4 className="title">
                                    ...
                                    <p>
                                        New Zealand is fast becoming a top destination for professionals seeking not
                                        just jobs but meaningful careers and a lifestyle to match. With its innovative
                                        industries, inclusive work culture, and exceptional quality of life, it’s more
                                        than a workplace it’s a fresh start.
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12">
                                <div className="content">
                                    <h6>Recognitions</h6>
                                    <h2 className="fw-bold">Accreditations & Affiliations</h2>
                                    <p>
                                        We are recognized and affiliated with leading international authorities in immigration, law, and language testing.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-8 offset-lg-2 col-12">
                            <div className="clients-logos">
                                <div className="single-image">
                                    <img src="/images/logos/Australia-Logo.png" alt="Brand Logo Images"/>
                                </div>
                                <div className="single-image">
                                    <img src="/images/logos/canada-logo.png" alt="Brand Logo Images"/>
                                </div>
                                <div className="single-image">
                                    <img src="/images/logos/canada-logo-2.png" alt="Brand Logo Images"/>
                                </div>
                                <div className="single-image">
                                    <img src="/images/logos/idp-logo.png" alt="Brand Logo Images"/>
                                </div>
                                <div className="single-image">
                                    <img src="/images/logos/IELTS_logo.png" alt="Brand Logo Images"/>
                                </div>
                                ...
                                <div className="row">
                                    <div className="col-xl-10 col-lg-8 mx-auto">
                                        <div className="section-title text-center">
                                            ...
                                            <p>
                                                Got migration questions? Fill out the form below and our team will
                                                connect with you to guide your next steps.
                                            </p>
                                        </div>
                                    </div>
                                </div>
