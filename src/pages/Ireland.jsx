export default function Ireland() {
    return(
        <>
            <section id="call-action" className="call-action ireland">
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 col-12">
                            <div className="about-image-five">
                                ...
                                <img src="/assets/images/ireland-1.jpg" alt="Ireland Immigration"/>
                            </div>
                        </div>
                        <div className="col-lg-6 col-12">
                            <div className="about-five-content">
                                <h6 className="small-title text-lg">OUR SERVICES</h6>
                                <h2 className="main-title fw-bold">Immigration Programmes in Ireland</h2>
                                <div className="about-five-tab">
                                    <nav>
                                        <div className="nav nav-tabs" id="nav-tab-ireland" role="tablist">
                                            <button className="nav-link active" id="nav-vision-ireland-tab"
                                                    data-bs-toggle="tab" data-bs-target="#nav-vision-ireland"
                                                    type="button" role="tab" aria-controls="nav-vision-ireland"
                                                    aria-selected="true">Programmes offered
                                            </button>
                                        </div>
                                    </nav>
                                    <div className="tab-content" id="nav-tabContent-ireland">
                                        <div className="tab-pane fade show active" id="nav-vision-ireland"
                                             role="tabpanel" aria-labelledby="nav-vision-ireland-tab">
