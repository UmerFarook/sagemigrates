                    ...
                    <div className="row">
                            ...
                            <div className="single-news">
                                <div className="image">
                                    <a href="javascript:void(0)"><img className="thumb"
                                                                      src="/assets/images/blog/australia.jpg"
                                                                      alt="Blog"/></a>
                        ...
                        <div className="col-lg-3 col-md-6 col-12">
                            ...
                            <div className="single-news">
                                <div className="image">
                                    <a href="javascript:void(0)"><img className="thumb"
                                                                      src="/assets/images/blog/europe-3.jpg"
                                                                      alt="Blog"/></a>
                                    <div className="meta-details">
                        ...
                        <div className="col-lg-3 col-md-6 col-12">
                            ...
                            <div className="single-news">
                                <div className="image">
                                    <a href="javascript:void(0)"><img className="thumb"
                                                                      src="/assets/images/blog/canada.jpg" alt="Blog"/></a>
                                    <div className="meta-details">
                        ...
                        <div className="col-lg-3 col-md-6 col-12">
                            ...
                            <div className="single-news">
                                <div className="image">
                                    <a href="javascript:void(0)"><img className="thumb"
                                                                      src="/assets/images/blog/new-zealand.jpg"
                                                                      alt="Blog"/></a>
                                    <div className="meta-details">
                        ...
                        <div className="col-lg-8 offset-lg-2 col-12">
                            <div className="clients-logos">
                                <div className="single-image">
                                    <img src="/assets/images/logos/Australia-Logo.png" alt="Brand Logo Images"/>
                                </div>
                                <div className="single-image">
                                    <img src="/assets/images/logos/canada-logo.png" alt="Brand Logo Images"/>
                                </div>
                                <div className="single-image">
                                    <img src="/assets/images/logos/canada-logo-2.png" alt="Brand Logo Images"/>
                                </div>
                                <div className="single-image">
                                    <img src="/assets/images/logos/idp-logo.png" alt="Brand Logo Images"/>
                                </div>
                                <div className="single-image">
                                    <img src="/assets/images/logos/IELTS_logo.png" alt="Brand Logo Images"/>
                                </div>
