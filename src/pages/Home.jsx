                ...
                <div className="row align-items-center">
                    <div className="col-lg-6 col-12">
                        <div className="about-image-five">
                            ...
                            <img src="src/assets/images/about/about-img1.jpg" alt="about" />
                        </div>
                    </div>
                    <div className="col-lg-6 col-12">
                ...
                <div className="row justify-content-center">
                    <div className="col-xxl-6 col-xl-7 col-lg-8 col-md-9">
                        <div className="inner-content">
                            <img src="src/assets/images/logo-white.png" width="200"/>
                ...
                <div className="row">
                    <div className="col-lg-3 col-md-6 col-12">
                        ...
                        <div className="single-news">
                            <div className="image">
                                <a href="javascript:void(0)"><img className="thumb" src="src/assets/images/blog/australia.jpg" alt="Blog" /></a>
                                <div className="meta-details">
                                    <img className="thumb" src="src/assets/images/blog/australia.jpg" alt="Author" />
                                    <span>Read More</span>
                                </div>
                            </div>
                    ...
                    <div className="col-lg-3 col-md-6 col-12">
                        ...
                        <div className="single-news">
                            <div className="image">
                                <a href="javascript:void(0)"><img className="thumb" src="src/assets/images/blog/europe-3.jpg" alt="Blog" /></a>
                                <div className="meta-details">
                                    <img className="thumb" src="src/assets/images/blog/europe-3.jpg" alt="Author" />
                                    <span>Read more </span>
                                </div>
                            </div>
                            <div className="content-body">
                    ...
                    <div className="col-lg-3 col-md-6 col-12">
                        ...
                        <div className="single-news">
                            <div className="image">
                                <a href="javascript:void(0)"><img className="thumb" src="src/assets/images/blog/canada.jpg" alt="Blog" /></a>
                                <div className="meta-details">
                                    <img className="thumb" src="src/assets/images/blog/canada.jpg" alt="Author" />
                                    <span>Read More</span>
                                </div>
                            </div>
                            <div className="content-body">
                    ...
                    <div className="col-lg-3 col-md-6 col-12">
                        ...
                        <div className="single-news">
                            <div className="image">
                                <a href="javascript:void(0)"><img className="thumb" src="src/assets/images/blog/new-zealand.jpg" alt="Blog" /></a>
                                <div className="meta-details">
                                    <img className="thumb" src="src/assets/images/blog/new-zealand.jpg" alt="Author" />
                                    <span>Read More</span>
                                </div>
                            </div>
                            <div className="content-body">
