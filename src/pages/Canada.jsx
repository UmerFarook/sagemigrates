                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 col-12">
                            <div className="about-image-five">
                                ...
                                <img src="src/assets/images/canada-2.jpg" alt="about"/>
                            </div>
                        </div>
                        <div className="col-lg-6 col-12">
                                ...
                                <div className="about-five-tab">
                                    <nav>
                                        <div className="nav nav-tabs" id="nav-tab" role="tablist">
                                            <button className="nav-link active" id="nav-who-tab" data-bs-toggle="tab"
                                                    ...
                                                    aria-controls="nav-who" aria-selected="true">Why Canada?
                                            </button>
                                    ...
                                    <div className="tab-content" id="nav-tabContent">
                                        ...
                                        <div className="tab-pane fade show active" id="nav-who" role="tabpanel"
                                            ...
                                            <p>Discover the key advantages of migrating to Canada:</p>
                                            <ul className="general-list">
                                                <li>The world’s leading immigration program.</li>
                                                <li>Move to Canada in under 6 months.</li>
                                                <li>Canada aims to attract 1.1 million immigrants by 2027.</li>
                                                <li>Access free education for your children.</li>
                                                <li>Bring your relatives to Canada by sponsoring them.</li>
                                                <li>Canada is set to welcome 1.5 million newcomers by 2027.</li>
                                            </ul>
                                        </div>
                                        ...
                                        <div className="tab-pane fade" id="nav-vision" role="tabpanel"
                                            ...
                                            <p>Popular immigration programmes available in Canada include:</p>
                                            <ul className="general-list">
                                                <li>Express Entry</li>
                                                <li>PNP</li>
                                                <li>AIP</li>
